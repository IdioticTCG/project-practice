...
controller.A.onEvent(ControllerButtonEvent.Pressed, function on_a_pressed() {
    ...
    if (Nola.overlapsWith(Dream)) {
        ...
        Board52.setScale(3.5, ScaleAnchor.Middle)
        Board52.setPosition(75, 55)
...
function Minimax(Board3: any[], Player: number) {
...
function CheckBoard(Board5: any[]) {
    
}

let interactionCount = 0
let Board52 : Sprite = null
